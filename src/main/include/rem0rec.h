...
UNIV_INLINE
ibool rec_info_bits_get_deleted_flag(
    /*===========================*/
...
UNIV_INLINE
ibool rec_get_nth_field_extern_bit(
    /*=========================*/
    /* in: TRUE or FALSE */
    rec_t *rec, /* in: record */
...
rec_t *rec_convert_dtuple_to_rec_low(
    /*==========================*/
    /* out: pointer to the origin of physical
    record */
    byte *destination, /* in: start address of the physical record */
