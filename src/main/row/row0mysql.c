...
byte *row_mysql_read_var_ref_noninline(
    /*=============================*/
    /* out: field + 2 */
                              ...
                              pointers to this record! */
{
  ...
  for (i = 0; i < prebuilt->n_template; i++) {
    ...
    row_mysql_store_col_in_innobase_format(dfield, prebuilt->ins_upd_rec_buff + templ->mysql_col_offset,
                                           mysql_rec + templ->mysql_col_offset, templ->mysql_col_len, templ->type,
                                           templ->is_unsigned);
  next_column:;
  }
}
...
handle_new_error:
  ...
  if (err == DB_DUPLICATE_KEY) {
    ...
    *new_err = err;
    ...
    fprintf(stderr, "InnoDB: The database cannot continue operation because of\n"
    ...
    dict_table_t *table) /* in: Innobase table handle */
{
  ...
  prebuilt->search_tuple = dtuple_create(heap, dict_table_get_n_cols(table));
    ...
    row_prebuilt_t *prebuilt) /* in: prebuilt struct */
{
  ...
  if (counter > 2000000000 ||
      ((ib_longlong)counter > (UNIV_PAGE_SIZE * prebuilt->table->stat_clustered_index_size) / 16)) {
                              ...
                              handle */
{
  ...
  if (srv_created_new_raw || srv_force_recovery) {
    fprintf(stderr, "InnoDB: A new raw disk partition was initialized or\n"
                              ...
                              handle */
{
  ...
  if (prebuilt->upd_node == NULL) {
    ...
    node->update = upd_create(dict_table_get_n_cols(table), prebuilt->heap);
    ...
    trx_t *trx)          /* in: transaction handle */
{
  ...
  old_name[ut_strlen(table->name) - ut_strlen("_recover_innodb_tmp_table")] = '\0';
    ...
    trx_t *trx)          /* in: transaction handle */
{
  ...
  if (0 == ut_strcmp(table->name, "mysql/host") || 0 == ut_strcmp(table->name, "mysql/user") ||
  ...
  if (namelen >= keywordlen &&
      0 == ut_memcmp(table->name + namelen - keywordlen, "_recover_innodb_tmp_table", keywordlen)) {
  ...
  if (namelen >= keywordlen && 0 == ut_memcmp(table->name + namelen - keywordlen, "innodb_monitor", keywordlen)) {
  ...
  if (namelen >= keywordlen && 0 == ut_memcmp(table->name + namelen - keywordlen, "innodb_lock_monitor", keywordlen)) {
  ...
  if (namelen >= keywordlen &&
      0 == ut_memcmp(table->name + namelen - keywordlen, "innodb_tablespace_monitor", keywordlen)) {
  ...
  if (namelen >= keywordlen && 0 == ut_memcmp(table->name + namelen - keywordlen, "innodb_table_monitor", keywordlen)) {
  ...
  if (namelen >= keywordlen && 0 == ut_memcmp(table->name + namelen - keywordlen, "innodb_mem_validate", keywordlen)) {
  ...
  if (err != DB_SUCCESS) {
    ...
    if (err == DB_OUT_OF_FILE_SPACE) {
      ...
      fprintf(stderr,
              ...
              table->name);
      fprintf(stderr, "InnoDB: You can drop the orphaned table inside InnoDB by\n"
    ...
    trx_t *trx)          /* in: transaction handle */
{
  ...
  if (namelen >= keywordlen &&
      0 == ut_memcmp(index->table_name + namelen - keywordlen, "_recover_innodb_tmp_table", keywordlen)) {
                      ...
                      database_name/table_name */
{
  ...
  if (namelen >= keywordlen && 0 == ut_memcmp(name + namelen - keywordlen, "_recover_innodb_tmp_table", keywordlen)) {
    ...
    char *name) /* in: table name */
{
  ...
  if (error != DB_SUCCESS) {
    fprintf(stderr, "InnoDB: Error: Dropping table %s in background drop list failed\n", name);
  }
...
static void row_add_table_to_background_drop_list(
    /*==================================*/
                          ...
                          dictionary system mutex */
{
  ...
  if (namelen >= keywordlen && 0 == ut_memcmp(name + namelen - keywordlen, "innodb_monitor", keywordlen)) {
  ...
  if (namelen >= keywordlen && 0 == ut_memcmp(name + namelen - keywordlen, "innodb_lock_monitor", keywordlen)) {
  ...
  if (namelen >= keywordlen && 0 == ut_memcmp(name + namelen - keywordlen, "innodb_tablespace_monitor", keywordlen)) {
  ...
  if (namelen >= keywordlen && 0 == ut_memcmp(name + namelen - keywordlen, "innodb_table_monitor", keywordlen)) {
  ...
  str1 = "PROCEDURE DROP_TABLE_PROC () IS\n"
         "table_name CHAR;\n"
         "sys_foreign_id CHAR;\n"
         "table_id CHAR;\n"
         "index_id CHAR;\n"
...
loop:
  ...
  while (table_name = dict_get_first_table_name_in_db(name)) {
    ...
    if (err != DB_SUCCESS) {
      fprintf(stderr, "InnoDB: DROP DATABASE %s failed with error %lu for table %s\n", name, (ulint)err, table_name);
      break;
    }
  }
    ...
    trx_t *trx)     /* in: transaction handle */
{
  ...
  if (0 == ut_strcmp(new_name, "mysql/host") || 0 == ut_strcmp(new_name, "mysql/user") ||
  ...
  str1 = "PROCEDURE RENAME_TABLE_PROC () IS\n"
         "new_table_name CHAR;\n"
         "old_table_name CHAR;\n"
         "BEGIN\n"
         "new_table_name :='";
...
loop:
  ...
  *n_rows = *n_rows + 1;
  ...
  if (prev_entry != NULL) {
    ...
    cmp = cmp_dtuple_rec_with_match(prev_entry, rec, &matched_fields, &matched_bytes);
    contains_null = FALSE;
    ...
    if (cmp > 0) {
      fprintf(stderr, "Error: index records in a wrong order in index %s\n", index->name);
  ...
  while (index != NULL) {
    ...
    if (!btr_validate_tree(index->tree)) {
      ...
      if (index == dict_table_get_first_index(table)) {
        ...
        fprintf(stderr, "Error: index %s contains %lu entries, should be %lu\n", index->name, n_rows, n_rows_in_table);
      }
    }
