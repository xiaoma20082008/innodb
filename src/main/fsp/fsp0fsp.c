...
/*-------------------------------------*/
#define FSP_NOT_USED                                                                                                   \
  0 /* this field contained a value up to                                                                              \
    ...
    mtr_t *mtr)              /* in: mtr handle */
{
  ...
  ut_a(0 == ut_dulint_cmp(mtr_read_dulint(descr + XDES_ID, MLOG_8BYTES, mtr),
