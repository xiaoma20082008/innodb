...
#define rw_lock_s_lock(M) rw_lock_s_lock_func((M), 0, IB__FILE__, __LINE__)
/******************************************************************
NOTE! The following macros should be used in rw s-locking, not the
corresponding function. */

#define rw_lock_s_lock_gen(M, P) rw_lock_s_lock_func((M), (P), IB__FILE__, __LINE__)
/******************************************************************
NOTE! The following macros should be used in rw s-locking, not the
corresponding function. */

#define rw_lock_s_lock_nowait(M) rw_lock_s_lock_func_nowait((M), IB__FILE__, __LINE__)
/**********************************************************************
...
#define rw_lock_x_lock(M) rw_lock_x_lock_func((M), 0, IB__FILE__, __LINE__)
/******************************************************************
NOTE! The following macro should be used in rw x-locking, not the
corresponding function. */

#define rw_lock_x_lock_gen(M, P) rw_lock_x_lock_func((M), (P), IB__FILE__, __LINE__)
/******************************************************************
NOTE! The following macros should be used in rw x-locking, not the
corresponding function. */

#define rw_lock_x_lock_nowait(M) rw_lock_x_lock_func_nowait((M), IB__FILE__, __LINE__)
/**********************************************************************
NOTE! Use the corresponding macro, not directly this function! Lock an
