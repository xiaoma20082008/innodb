...
struct com_shm_endpoint_struct {
  ...
  UT_LIST_NODE_T(com_shm_endpoint_t)
  list; /* If the endpoint struct
...
UNIV_INLINE
ibool com_shm_endpoint_get_owns_shm(
    /*==========================*/
...
UNIV_INLINE
void com_shm_endpoint_set_owns_shm(
    /*==========================*/
    com_shm_endpoint_t *ep, ibool flag) {
  ut_ad(ep);
...
UNIV_INLINE
char *com_shm_endpoint_get_addr(
    /*======================*/
    com_shm_endpoint_t *ep) {
  ut_ad(ep);
  return (ep->addr);
...
UNIV_INLINE
void com_shm_endpoint_set_addr(
    /*======================*/
    com_shm_endpoint_t *ep, char *addr) {
  ut_ad(ep);
...
UNIV_INLINE
ulint com_shm_endpoint_get_addr_len(
    /*==========================*/
    com_shm_endpoint_t *ep) {
  return (ep->addr_len);
}
...
UNIV_INLINE
void com_shm_endpoint_set_addr_len(
    /*==========================*/
    com_shm_endpoint_t *ep, ulint len) {
  ut_ad(ep);
  ut_ad(len > 0);
...
ulint com_shm_endpoint_get_size(
    /*======================*/
    com_shm_endpoint_t *ep) {
  return (ep->size);
}
...
UNIV_INLINE
void com_shm_endpoint_set_size(
    /*======================*/
    com_shm_endpoint_t *ep, ulint size) {
  ut_ad(ep);
...
UNIV_INLINE
os_shm_t com_shm_endpoint_get_shm(
    /*=====================*/
    com_shm_endpoint_t *ep) {
  return (ep->shm);
}
...
UNIV_INLINE
void com_shm_endpoint_set_shm(
    /*=====================*/
    com_shm_endpoint_t *ep, os_shm_t shm) {
  ut_ad(ep);
  ut_ad(shm);
...
UNIV_INLINE
com_shm_t *com_shm_endpoint_get_map(
    /*=====================*/
    com_shm_endpoint_t *ep) {
  return (ep->map);
}
...
UNIV_INLINE
void com_shm_endpoint_set_map(
    /*=====================*/
    com_shm_endpoint_t *ep, com_shm_t *map) {
  ut_ad(ep);
  ut_ad(map);
...
UNIV_INLINE
os_event_t com_shm_endpoint_get_empty(
    /*=======================*/
    com_shm_endpoint_t *ep) {
  return (ep->empty);
}
...
UNIV_INLINE
void com_shm_endpoint_set_empty(
    /*=======================*/
    com_shm_endpoint_t *ep, os_event_t event) {
  ut_ad(ep);
  ut_ad(event);
...
UNIV_INLINE
os_event_t com_shm_endpoint_get_not_empty(
    /*===========================*/
    com_shm_endpoint_t *ep) {
  return (ep->not_empty);
}
...
UNIV_INLINE
void com_shm_endpoint_set_not_empty(
    /*===========================*/
    com_shm_endpoint_t *ep, os_event_t event) {
  ut_ad(ep);
  ut_ad(event);
...
UNIV_INLINE
void com_shm_set_valid(
    /*==============*/
    com_shm_info_t *info, ulint flag) {
  ut_ad(info);
...
UNIV_INLINE
void com_shm_set_not_empty(
    /*==================*/
    com_shm_info_t *info, ibool flag) {
  ut_ad(info);
...
UNIV_INLINE
void com_shm_set_empty_waiters(
    /*======================*/
    com_shm_info_t *info, ulint count) {
  ut_ad(info);
  ut_ad(count < 1000);
...
UNIV_INLINE
void com_shm_set_max_len(
    /*================*/
    com_shm_info_t *info, ulint len) {
  ut_ad(info);
  ut_ad(len > 0);
...
UNIV_INLINE
ip_mutex_t *com_shm_get_ip_mutex(
    /*=================*/
    com_shm_info_t *info) {
...
UNIV_INLINE
com_shm_endpoint_t *com_shm_destination_cache_search(
    /*=============================*/
    ...
    ulint len)  /* in: address length */
{
  ...
  */
  ...
  HASH_SEARCH(addr_hash, com_shm_destination_cache, fold, ep,
              ((ep->addr_len == len) && (0 == ut_memcmp(addr, ep->addr, len))));
...
static void com_shm_destination_cache_insert(
    /*=============================*/
    com_shm_endpoint_t *ep) /* in: endpoint struct to insert */
{
  ...
  /* Add to hash table */
  HASH_INSERT(com_shm_endpoint_t, addr_hash, com_shm_destination_cache, fold, ep);
...
cannot be freed. */
static void com_shm_destination_cache_no_binds(void)
/*====================================*/
{
  com_shm_endpoint_t *ep;
  ulint fold;
  ...
  while (UT_LIST_GET_LEN(com_shm_destination_list) != 0) {
    ...
    /*
                    printf("Deleting from dest. cache %s %lu fold %lu\n",
                                            ...
                                            ep->addr_len, fold);
    */
    HASH_DELETE(com_shm_endpoint_t, addr_hash, com_shm_destination_cache, fold, ep);
...
com_shm_endpoint_t *com_shm_endpoint_create(void)
/*=========================*/
...
ulint com_shm_endpoint_set_option(
    /*========================*/
...
static ulint com_shm_create_or_open(
    /*===================*/
    /* out: 0 if succeed, else error number */
    ...
    ulint len)              /* in: address name length */
{
  ...
  shm = os_shm_create(sizeof(com_shm_info_t) + COM_MAX_ADDR_LEN + com_shm_endpoint_get_size(ep), buf);
  if (shm == NULL) {
...
loop:
  ...
  if (com_shm_get_not_empty(map)) {
    ...
    com_shm_set_empty_waiters(map, 1 + com_shm_get_empty_waiters(map));
    com_shm_exit(ep2);
    ...
    ret = os_event_wait_time(com_shm_endpoint_get_empty(ep2), 10000000);
    ut_a(ret == 0);

    com_shm_enter(ep2);

    com_shm_set_empty_waiters(map, com_shm_get_empty_waiters(map) - 1);
    com_shm_exit(ep2);
  ...
  ut_memcpy(com_shm_get_addr(map), com_shm_endpoint_get_addr(ep), sender_len);
