...
#define SESS_CLI_MSG_CHECKSUM                                                                                          \
  0 /* the checksum should be the first                                                                                \
    field in the message */
#define SESS_CLI_MSG_SESS_ID                                                                                           \
  4                                   /* this is set to 0 if the client                                                \
...
#define SESS_CLI_MSG_CONTINUE                                                                                          \
  28 /* 0, or SESS_MSG_FIRST_PART                                                                                      \
     SESS_MSG_MIDDLE_PART, or                                                                                          \
     SESS_MSG_LAST_PART */
#define SESS_CLI_MSG_CONT_SIZE                                                                                         \
  32 /* size of a multipart message in                                                                                 \
...
#define SESS_SRV_MSG_CHECKSUM                                                                                          \
  0 /* the checksum should be the first                                                                                \
    field in the message */
#define SESS_SRV_MSG_SESS_ID 4
#define SESS_SRV_MSG_TYPE 12
#define SESS_SRV_MSG_NO 16
#define SESS_SRV_MSG_CONTINUE                                                                                          \
  24 /* 0, or SESS_MSG_FIRST_PART                                                                                      \
     SESS_MSG_MIDDLE_PART, or                                                                                          \
     SESS_MSG_LAST_PART */
#define SESS_SRV_MSG_CONT_SIZE                                                                                         \
  28 /* size of a multipart message                                                                                    \
