...
#define FIL_PAGE_FILE_FLUSH_LSN                                                                                        \
  26 /* this is only defined for the                                                                                   \
     ...
     to this lsn */
#define FIL_PAGE_ARCH_LOG_NO                                                                                           \
  34                     /* this is only defined for the                                                               \
...
/* File page trailer */
#define FIL_PAGE_END_LSN                                                                                               \
  8 /* this should be same as                                                                                          \
    FIL_PAGE_LSN */
...
void fil_reserve_right_to_open(void);
/*===========================*/
/***********************************************************************
Releases a right to open a single file. */

void fil_release_right_to_open(void);
/*===========================*/
/************************************************************************
