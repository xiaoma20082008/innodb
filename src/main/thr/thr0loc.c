...
try_again:
  ...
  HASH_SEARCH(hash, thr_local_hash, os_thread_conv_id_to_ulint(id), local, local->id == id);
  if (local == NULL) {
...
/*==================*/
{
  ...
  HASH_INSERT(thr_local_t, hash, thr_local_hash, os_thread_conv_id_to_ulint(os_thread_get_curr_id()), local);
    ...
    os_thread_id_t id) /* in: thread id */
{
  ...
  HASH_DELETE(thr_local_t, hash, thr_local_hash, os_thread_conv_id_to_ulint(id), local);
