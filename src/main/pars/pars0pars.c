    ...
    func_node_t *node) /* in: function node */
{
  ...
  if ((func == PARS_SUM_TOKEN) || (func == '+') || (func == '-') || (func == '*') || (func == '/') || (func == '+')) {
    ...
    ut_a(dtype_get_mtype(que_node_get_data_type(arg)) != DATA_ERROR);
    ...
    dtype_set(que_node_get_data_type(node), DATA_VARCHAR, DATA_ENGLISH, 0, 0);
             ...
             (func == PARS_NE_TOKEN) || (func == PARS_AND_TOKEN) || (func == PARS_OR_TOKEN) ||
             (func == PARS_NOT_TOKEN) || (func == PARS_NOTFOUND_TOKEN)) {
...
static void pars_retrieve_procedure_def(
    /*========================*/
    sym_node_t *sym_node) /* in: procedure name node */
{
  ...
  sym_node->procedure_def = dict_procedure_get((char *)sym_node->name, NULL);
    ...
    upd_node_t *node) /* in: update node */
{
  ...
  for (i = 0; i < n_assigns; i++) {
    ...
    upd_field_set_field_no(upd_field, dict_index_get_nth_col_pos(clust_index, col_sym->col_no), clust_index);
...
ulint pars_write_query_param_info(
    /*========================*/
    ...
    que_fork_t *graph) /* in: parsed query graph */
{
  ...
  if (que_node_get_type(thr->child) == QUE_NODE_CALL) {
    ...
    stored_graph = dict_procedure_reserve_parsed_copy(procedure_def);
...
void pars_proc_read_input_params_from_buf(
    /*=================================*/
...
ulint pars_proc_write_output_params_to_buf(
    /*=================================*/
                  ...
                  in the buffer */
{
  ...
  if (pars_print_lexed) {
    ...
    ut_memcpy(print_buf, pars_sym_tab_global->sql_string + pars_sym_tab_global->next_char_pos, len);
    print_buf[len] = '\0';
