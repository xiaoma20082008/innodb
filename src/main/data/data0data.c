    ...
    ulint n_ext_vec)     /* in: number of elements is ext_vec */
{
  ...
  while ((rec_get_converted_size(entry) >= page_get_free_space_of_empty() / 2) ||
...
static ulint dtuple_gen_rnd_ulint(
    /*=================*/
    /* out: random ulint */
    ulint n1, ulint n2, ulint n3) {
  ulint m;
  ulint n;
